  ...
  return (
    <div>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-9">
        <section className="order-2 col-span-5 mx-auto max-w-xl pb-12 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
          <Link href="/">
          ...
          <div className="border-grey-300 mx-4 divide-y divide-gray-300 rounded-md border p-4 lg:ml-14">
        ...
        {mounted && (
          <section
            className="overflow-y-scroll border-y border-l border-gray-300 bg-[#FAFAFA] lg:order-2 lg:col-span-4
          lg:h-screen lg:border-y-0"
          >
            <div
              className={`w-full ${
                showOrderSummaryCondition && "border-b "
              } border-grey-300 ld:hidden text-sm`}
            >
              ...
              <div className="mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0 lg:max-w-lg lg:px-10 lg:py-16">
                <div className="space-y-4 pb-4">
                  {products.map((product) => (
                    ...
                    >
                      <div
                        className="border-grey-300 relative flex h-16 w-16 items-center justify-center rounded-md border
